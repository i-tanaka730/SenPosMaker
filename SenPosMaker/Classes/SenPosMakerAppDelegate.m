...
@implementation SenPosMakerAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [defaults setObject:@"" forKey:USER_NAME];  // USER_NAME
    ...
    self.viewController = [[SenPosMakerViewController alloc] initWithNibName:@"SenPosMakerViewController" bundle:nil];
